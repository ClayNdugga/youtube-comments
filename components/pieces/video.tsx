import { ArrowDownRight, MessageCircleMore, ThumbsUp, Eye, Timer, Calendar } from "lucide-react";
...
const Video = React.forwardRef(({video}: Props, ref) => {
  ...
  return (
    <section className="pt-32 pb-12" ref={ref}> {/* Attach the ref here */}
      <div className="container">
        <div className="grid items-center gap-8 lg:grid-cols-2">
          ...
          <div className="flex flex-col items-center text-center lg:items-start lg:text-left">
            <h1 className="my-6 text-pretty text-4xl font-bold lg:text-6xl">{snip.snippet.title}</h1>
...
//   return (
//     <section className="py-32"> {/* Attach the ref here */}
//       <div className="container">
//         <div className="grid items-center gap-8 lg:grid-cols-2">
//           <img
//             src={snip.snippet.thumbnails.standard.url}
