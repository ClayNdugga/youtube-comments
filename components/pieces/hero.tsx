...
import { fetchYoutubeComments } from "../../app/services/api/youtube";
...
import tempData from "../../app/entities/tempComments"
...
//   const videoId = "L_Q9JzDY5mg";
//   const searchTerms = "chris";
//   try {
//     const comments = await fetchYoutubeComments(videoId, searchTerms);
...
const Hero = () => {
  ...
  // const { data, error, isLoading } = useYoutubeComments(videoId, searchTerms);

  const handleSearch = () => {
    console.log(searchTerms);
    console.log(parseYouTubeVideoId(searchTerms));
    setVideoId(searchTerms);
  };
    ...
    <div className="min-h-screen flex flex-col">
      <main className="flex-grow flex flex-col justify-center items-center text-center w-full">
        ...
        <div className="max-w-2xl w-full mx-auto px-4">
          ...
          {/* Search Bar */}
          <SearchBar className="py-10" onSearch={handleSearch} />
          ...
          <CommentSection fetchedComments={tempData} />
