...
const Background = () => {
  return (
    <div className="fixed inset-x-0 top-0 -z-50 flex size-full items-center justify-center opacity-100 py-0">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 2000 1125" preserveAspectRatio="xMidYMid meet" className="h-full">
